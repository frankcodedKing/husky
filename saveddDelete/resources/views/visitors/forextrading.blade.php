            ...
            <div class="row">
                <div class="col-md-12">
                 ...
                 <p>
                  ...
                  <p>
    <strong>
      Our best trading strategy- Gap Trading</strong>
<br>A gap occurs when where no trading activity has taken place. This happens when an asset’s price moves sharply high or low with nothing in between, implying the market has opened at a different price to its previous close. 
...
<br> <strong>
  Advantages of Forex Trading – Leverage, Liquidity, and Volatility </strong>
<br>
...
easily be analyzed with the use of charting and technical analysis. <br>
<strong>Volatility</strong><p>
  ...
  The advantage of volatility is enhanced by the fact in forex trading, it is just as easy to sell short as it is to buy long. There are no 
  restrictions on short selling such as those that exist in stock markets. A wide daily trading range, with equal opportunities to 
  profit from both buying and selling, makes the forex market very attractive to speculators.</p>
    <h3 class="text-center">Forex markets chart</h3>
    <!-- TradingView Widget BEGIN -->
{{-- <div class="tradingview-widget-container">
  <div id="tradingview_61bd1"></div>
  ...
  "container_id": "tradingview_61bd1"
}
  );
  </script>
</div> --}}
