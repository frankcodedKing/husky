...
height:180px;"
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="2">Read Bio</button>
                                ...
                                <div class="panel" id="2">
                                    <p class="card-description">
                                        Hieu Jang has vast experience in the financial services industry spanning over 47
                                        ...
                                        <br>
                                        Hieu built and strengthens relationships with Investors, shareholders and
                                        organizations by assisting them in multi-generational wealth management.  Embracing
                                        technology Hieu employs a strategy-based approach in helping Aspen's clients address
                                        ...
                                        service. Hieu has been committed to designing tax-efficient strategies, constructed
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile text-center">
                            ...
                            <div class="card-body ">
                                ...
                                <button class="btn btn-primary accordy" id="1">Read Bio</button>
                                ...
                                <div class="panel" id="1">
                                    <p class="card-description">
                                        ...
                                        founding members of Aspen financial along side his old long friend Hieu jang they've
                                        ...
                                        Michael saw the vision hieu had and ensured it was materialized, he brought over 18
...
height:180px;  "
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-category text-muted"> cofounder</h6>
                                <button class="btn btn-primary accordy" id="3">Read Bio</button>


                                <!--dropdown-->
                                <div class="panel" id="3">
                                    <p class="card-description">
                                        Shihad Hicklin with over 23 years experience as a marketer and expert strategist, He
                                        Co-founded Aspen financial management. With the involvement of Hicklin, Aspen
                                        ...
                                        position. So Hicklin majorly responsible for all marketing and strategy activities.
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile text-center">
                            ...
                            <div class="card-body ">
                                ...
                                <button class="btn btn-primary accordy" id="4">Read Bio</button>
                                ...
                                <div class="panel" id="4">
                                    <p class="card-description">
                                        ...
                                        David William Davies is the chief Executive officer of Aspen financial Management,
                                        which is now a $165 billion+ investment establishment and assets management firm
                                        serving large institutions and high net worth individuals globally. David William
                                        Davies has been with the firm since its inception, and has worked his way through to
                                        the top with his continuous hardwork. By elite standards, it is a world’s largest
                                        pure ‘40 Act Investment Adviser firm. William’s prestigious Bloomberg article
                                        “diversifying your portfolio” column ran monthly for six months until 12/31/2016,
                                        making William one of the longest running columnist in the magazine’s history. An
                                        inspirational leader and insightful who embodies our firms core beliefs and values.
                                        He is an experienced senior portfolio manager with a demonstrated history.David
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="5">Read Bio</button>
                                ...
                                <div class="panel" id="5">
                                    <p class="card-description">
                                        Mark Luthor Siegel, Vice President, Director and a member of
                                        {{ $compd ? $compd->companyname : 'company name' }}’s Global Executive Committee
                                        and
                                        directs the firm’s day-to-day operations and oversees its four primary business
                                        ...
                                        Client Acquisition and Service. Siegel has been an Executive Officer and member of
                                        ...
                                        Siegel regularly publishes articles in various industry publications, including FT
                                        Adviser, Financial Advisor, Advisor Perspectives, Financial Advisor IQ, FE Trustnet
                                        and Investment News.Education - Mark Luthor Siegel earned a BS degree in economics
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="6">Read Bio</button>
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="7">Read Bio</button>
...
height:180px;"
                            ...
                            <div class="card-body ">
                                ...
                                <button class="btn btn-primary accordy" id="8">Read Bio</button>
                                ...
                                <div class="panel" id="8">
                                    <p class="card-description">
                                        ...
                                        Emily Marling is an Experienced Portfolio Manager. In those roles, she oversees the
...
height:180px;"
                            ...
                            <div class="card-body ">
                                ...
                                <button class="btn btn-primary accordy" id="9">Read Bio</button>
                                ...
                                <div class="panel" id="9">
                                    <p class="card-description">
                                        ...
                                        Ren Suen joined Aspen Financial Management at its inception, Suen was previously a
                                        Logistician in the US Army. Suen is a strategic and experienced Managing Director
                                        ...
                                        multiple industry verticals. Suen is known for identifying and implementing various
                                        ...
                                        Suen has served on the Board of Directors of numerous companies, including Barfield
                                        and Powell. Suen is a graduate of the University of Virginia where he earned a
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy " id="10">Read Bio</button>
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="11">Read Bio</button>
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="12">Read Bio</button>
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="13">Read Bio</button>
...
height:180px; "
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary accordy" id="14">Read Bio</button>
...
height:180px;"
                            ...
                            <div class="card-body ">
                                ...
                                <button class="btn btn-primary accordy" id="15">Read Bio</button>
                                <!--dropdown-->
                                <div class="panel"id="15">
                                    <p class="card-description">

                                        With over 10 years of experience in the digital world and project management
                                        Mattew’s as the Digital Specialist's role is to design, create, and deliver
