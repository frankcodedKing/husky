...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">My Investments</a></li>
                        ...
                        <thead>
                         ...
                         <tbody>
                          ...
                          <tr><td class="text-center">{{$loop->index + 1}}</td>
                             <td><a href="#" class="text-yellow hover-warning">{{$investment->investmentplan}}</a></td>     <td class="text-right">$ {{$investment->investmentamount}}</td>
