...
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xl-3 mb-4">
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">Principal</h2>
                                <h3 class="fw-extrabold mb-1">{{ $funds->balance }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Principal</h2>
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="icon-shape icon-shape-danger rounded me-4 me-sm-0">
                                <i class="fa faa fa-money" aria-hidden="true"></i>
                            </div>
                            <div class="d-sm-none">
                                <h2 class="h5">Dividend</h2>
                                <h3 class="fw-extrabold mb-1">{{ $funds->currentprofit }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Dividend</h2>
                                <h3 class="fw-extrabold mb-2"><i class="fa fa-usd"
                                        aria-hidden="true"></i>{{ $funds->currentprofit }}</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <div class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                                <i class="fa fa-credit-card" aria-hidden="true" style="font-size:36px"> </i>
                            </div>
                            <div class="d-sm-none">
                                <h2 class="h5">E-Bank</h2>
                                <h3 class="fw-extrabold mb-1">{{ $funds->ebalance }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">E-Bank</h2>
                                <h3 class="fw-extrabold mb-2"><i class="fa fa-usd"
                                        aria-hidden="true"></i>{{ $funds->ebalance }}</h3>
                            </div>
                            <small class="d-flex align-items-center text-gray-500">
        ...
        <!--                    class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">-->
        <!--                    <div class="icon-shape icon-shape-primary rounded me-4 me-sm-0">-->
        <!--                        <i class="fa fa-recycle" aria-hidden="true" style="font-size:36px"></i>-->
        <!--                    </div>-->
        <!--                    <div class="d-sm-none">-->
        <!--                        <h2 class="h5">Statistics</h2>-->
        <!--                        <h3 class="fw-extrabold mb-1">0/4</h3>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--                <div class="col-12 col-xl-7 px-xl-0">-->
        <!--                    <div class="d-none d-sm-block">-->
        <!--                        <h2 class="h6 text-gray-400 mb-0">Statistics</h2>-->
        <!--                        <h3 class="fw-extrabold mb-2">0/4</h3>-->
        <!--                    </div>-->
        <!--                    <small class="d-flex align-items-center text-gray-500">-->
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <div class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                                <i class="fa faa fa-users" aria-hidden="true"></i>
                            </div>
                            <div class="d-sm-none">
                                <h2 class="h5">Referral Bonus</h2>
                                <h3 class="fw-extrabold mb-1">{{ $funds->bonus }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Referral Bonus</h2>
                                <h3 class="fw-extrabold mb-2"><i class="fa fa-usd"
    ...
    <figure>
        <div class="button-div">
            <button class="btn btn-primary not-button accordy" id="e1">Deposit/Withdraw</button> <button
                class="btn btn-success not-button accordy" id="e2">show/hide referral links</button>
        </div>
    </figure>
    ...
    <div class="row" style="position: relative; width:100%;">
        ...
        <div class="row">
            <div class="col-md-7  stretch-card panel" id="e1" >
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <!--        <p style="margin-bottom: 0.5rem;" class="text-muted">Total Assets</p>-->
                        <!--        <h1 class="font-weight-medium mb-0">${{ $funds->totalbalance }}</h1>-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <div class="d-flex flex-row mb-3">
                            ...
                            <a href="{{ route('dashb_deposits') }}" class="btn btn-outline-success mr-1"><i
                                    class="fa fa-upload"></i>
                                Deposit</a>
                            <a href="{{ route('dashb_withdrawals') }}" class="btn btn-outline-warning mr-1"><i
                                    class="fa fa-download"></i>
                                Withdraw</a>
                            <a href="{{ route('dashb_funds_tranfer') }}"
                                class="btn btn-outline-primary d-none d-md-block"><i class="fa fa-exchange"></i>
                                Transfer</a>
                        </div>
            ...
            <div class="col-md-5 stretch-card panel" id="e2" >
                        ...
                        <div class="wrapper">
                            ...
                            <div class="row">
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='' method="post">
                                        <a href="mailto:?subject=Invitation&body=Hello%20dear%20I%20am%20happy%20to%20invite%20you%20to%20join%20aspen-fm%20a%20reliable%20investment%20website%20that%20helps%20you%20to%20trade%20and%20return%20your%20profit.%20Use%20my%20link%20to%20register%20{{ route('register') }}%3Frefid%3D{{ Auth::user()->id }}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://wa.me/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+aspen-fm+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{ route('register') }}%3Frefid%3D{{ Auth::user()->id }}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://t.me/share/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+aspen-fm+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{ route('register') }}%3Frefid%3D{{ Auth::user()->id }}"
                            ...
                            <form class="forms-sample mt-3">
                                ...
                                <button id='ref_btn' type="button" onclick="copy_ref('ref_cop','#ref_btn');"
                                    class="btn btn-primary btn-block"><i class='fa fa-copy'></i> Copy Referral
                                    Link</button>
                            </form>
    ...
    <!--                                                    viewBox="0 0 20 20"i xmlns="http://www.w3.org/2000/svg">-->
    <!--                                                    <path fill-rule="evenodd"-->
