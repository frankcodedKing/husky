...
@section('body')
                ...
                @foreach ($plans as $plan)
                                ...
                                <div
                                    ...
                                    <h3 class="mb-3 text-center" style="color:white;padding-top: 20px;">
                                        @if ($plan->percentage == 0.42)
                                            11% - 15% ROI
                                            <input type="hidden" class="hiddenminimum{{ $loop->index + 1 }}" name=""
                            value="11">
                            <input type="hidden" class="hiddenmaximum{{ $loop->index + 1 }}" name=""
                            value="15">
                    ...
                    <section class="anchor" id="e{{ $loop->index + 1 }}">
                        ...
                        <form action="{{ route('dashb_plans') }}" method="POST">
                            @csrf
                            <input type="hidden" hidden name="plan" value="{{ $plan->name }}" id="">
                                    ...
                                    <div class="investment__review-form">
                                        ...
                                        <figure class="invest__form-section">
                                            <div class="invest__input">
                                                ...
                                                <figcaption>
                                                    <span><input type="text" name="amount"
                                                            class="investamount{{ $loop->index + 1 }}" /></span>
                                                </figcaption>
                                            </div>
                                            <div class="invest__input">
                                                ...
                                                <figcaption class="invest__flex">
                                                    ...
                                                    <span><input type="text" class="monthly1" /></span>
                                                </figcaption>
                                            </div>
                                            <div class="invest__input">
                                                ...
                                                <figcaption class="invest__flex">
                                                    ...
                                                    <span><input type="text" class="yearly1" /></span>
                                                </figcaption>
                                            </div>
                                            <div class="invest__input">
                                                ...
                                                <figcaption class="invest__flex">
                                                    ...
                                                    <span><input type="text" class="total1" /></span>
                                                </figcaption>
                                            </div>
                                        </figure>
                                    </div>
    ...
    <script>
        ...
        let monthly1 = document.querySelectorAll('.monthly1')
        let yearly1 = document.querySelectorAll('.yearly1')
        ...
        let maxProfit = 15 / 100
          let maxProf = 20/ 100
            let maxProft = 25 / 100
        invested.addEventListener('keyup', () => {
            let profit = hidden/ 100;
           
            let investval = invested.value * profit
            let maxVal = maxProfit * invested.value
            monthly.forEach((month) => {
                month.value = investval
            })
            monthly1.forEach((month1) => {
                month1.value = maxVal
            })
            yearly.forEach((year) => {
                year.value = investval * 24;
                total.forEach((sum) => {
                    sum.value = year.value - invested.value
                })
            })
            yearly1.forEach((year1) => {
                year1.value = maxVal * 24;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested.value
                })
            })
        })

       invested2.addEventListener('keyup', () => {
            let profit = hidden2/ 100;
           
            let investval = invested2.value * profit
            let maxVal = maxProf * invested2.value
            monthly.forEach((month) => {
                month.value = investval
            })
            monthly1.forEach((month1) => {
            ...
            yearly1.forEach((year1) => {
                year1.value = maxVal * 24;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested2.value
                })
            })
        })
        ...
        invested3.addEventListener('keyup', () => {
            let profit = hidden3/ 100;
           
            let investval = invested3.value * profit
            let maxVal = maxProft * invested3.value
            monthly.forEach((month) => {
                month.value = investval
            })
            monthly1.forEach((month1) => {
            ...
            yearly1.forEach((year1) => {
                year1.value = maxVal * 24;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested3.value
                })
            })
        })
    //    this section is no valid
        invested4.addEventListener('keyup', () => {
            let profit = hidden4.value / 100;
            console.log(profit)
            let investval = invested4.value * 30 * profit
            let maxVal = (investval / profit) * maxProfit
            monthly.forEach((month) => {
            ...
            yearly1.forEach((year1) => {
                year1.value = maxVal * 12;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested4.value
                })
            })
        })
        invested5.addEventListener('keyup', () => {
            ...
            yearly1.forEach((year1) => {
                year1.value = maxVal * 12;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested5.value
                })
            })
        })
        ...
        invested6.addEventListener('keyup', () => {
            ...
            yearly1.forEach((year1) => {
                year1.value = maxVal * 12;
                total1.forEach((sum1) => {
                    sum1.value = year1.value - invested6.value
                })
            })
        })
