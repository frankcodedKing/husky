                        ...
                        <div class="card card-default card-fill">
                            ...
                            <div class="card-body">
                                ...
                                <div class="about-info-p">
                                    ...
                                    <br>
                                    <p class="text-muted">{{ $user->adminmessage }}/4</p>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-default card-fill">
                            ...
                            <div class="card-body">
                                ...
                                <div class="about-info-p m-b-0">
                                    <strong class="text-dark">Dividend </strong>
                                    <br>
                                    <p class="text-muted">$ {{ $fund->currentprofit }}</p>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="adminmessage"
                                                    placeholder="User statistics value" value="{{$user->adminmessage}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Maximum Daily Withdraw</label>
                                                <input type="number" value="{{ $fund->withdrawal_maximum }}" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" required value="{{ $fund->withdrawal_minimum }}" class="form-control"
                                                    name="minimum" placeholder="00000" required value="0">
                                            </div>
                                        </div>
                                        {{-- <div class="col-xl-12">
                                            <div class="form-group">
            ...
            <div class="card-body">
                <div class="row">
                                                    ...
                                                    <tbody>
                                                        <form action="{{ route('editbalance') }}" method="POST">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="hidden" name="totalprofit"
                                                                        value="{{ $fund->totalprofit }}"> 

                                                                <td><input type="number" name="currentprofit"
                                                                        value="{{ $fund->currentprofit }}"> </td>
                                                                        
                                                                        <td><input type="number" name="ebalance"
                                                                        value="{{ $fund->ebalance }}"> </td>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h3 class="card-title text-white">KYC Document</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12">
                                    ...
                                    <img src="{{ asset('kyc_files/'.$userdoc->file_name) }}" class="card-img-top" alt="file">
                                    
                                        <p>{{ $userdoc->file_name }} </p>
