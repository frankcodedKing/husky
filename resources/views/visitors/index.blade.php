...
<div class="container" data-aos="zoom-out" data-aos-delay="100">
  <div class="row">
    <div class="col-xl-6">
      <h1>Digital Assets Investment With Apsen</h1>
      <h2>Team of talented Portfolio managers</h2>
  ...
  <div class="container" data-aos="zoom-in">
    ...
    <div class="clients-slider swiper">
      <div class="swiper-wrapper align-items-center">
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-1.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-2.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-3.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-4.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-5.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-6.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-7.png')}}" class="img-fluid" alt=""></div>
        <div class="swiper-slide"><img src="{{asset('assets/fronto/assets/img/clients/client-8.png')}}" class="img-fluid" alt=""></div>
      </div>
    ...
    <div class="row no-gutters">
      <div class="content col-xl-5 d-flex align-items-stretch">
        <div class="content">
          <h3>What we offer</h3>
          <p>
            Aspen Financial Management offers personalized financial services with a disciplined investment strategy. They prioritize their clients' needs and provide comprehensive financial planning, retirement planning, and portfolio management services. Their steady guidance helps clients stay on track, even during market uncertainties.
          </p>
          <a href="#" class="about"><span>About us</span> <i class="bx bx-chevron-right"></i></a>
        </div>
      </div>
        ...
        <div class="icon-boxes d-flex flex-column justify-content-center">
          <div class="row">
            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4>Open and Honest Discussions</h4>
            ...
            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <h4>Creating a Financial Picture</h4>
            ...
            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4>Making your Goals a Reality</h4>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="count-box">
          ...
          <span data-purecounter-start="0" data-purecounter-end="3732" data-purecounter-duration="1" class="purecounter"></span>
          <p>Happy Clients</p>
        </div>
      </div>
...
<!-- <section id="tabs" class="tabs">
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-title">
      <h2>What We Offer</h2>
      <p>Aspen Financial Management offers personalized financial services with a disciplined investment strategy. They prioritize their clients' needs and provide comprehensive financial planning, retirement planning, and portfolio management services. Their steady guidance helps clients stay on track, even during market uncertainties.</p>
    </div>
    ...
    <ul class="nav nav-tabs row d-flex">
      <li class="nav-item col-3">
        <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#tab-1">
          ...
          <h4 class="d-none d-lg-block">Portfolio Management</h4>
        </a>
      </li>
      <li class="nav-item col-3">
        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-2">
          <i class="ri-body-scan-line"></i>
          <h4 class="d-none d-lg-block">Retirement Planning</h4>
        </a>
      </li>
      <li class="nav-item col-3">
      ...
      <li class="nav-item col-3">
        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-4">
          ...
          <h4 class="d-none d-lg-block">Tailored Investment Approach</h4>
        </a>
      </li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab-4">
        <div class="row">
          <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
            <h3>Tailored Investment Approach</h3>
            <p>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
          ...
          <h4><a href="{{route('portfoliomanagement')}}">Portfolio Management</a></h4>
      ...
      <div class="col-md-6 mt-4 mt-md-0">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
          ...
          <h4><a href="{{route('retirement')}}">Retirement Planning</a></h4>
          <p>We take a comprehensive approach to retirement planning that will prioritize your goals and develop an all-inclusive strategy to achieve those goals.</p>
        </div>
      </div>
      <div class="col-md-6 mt-4 mt-md-0">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
          <i class="bi bi-bar-chart"></i>
          <h4><a href="{{route('finacialplaning')}}">Financial Planning</a></h4>
          <p>Women who are single, widowed, or divorced face the challenge of identifying the needs that must be addressed today, while setting and working towards goals for tomorrow.<p>
        </div>
      </div>
      <div class="col-md-6 mt-4 mt-md-0">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
          <i class="bi bi-binoculars"></i>
          <h4><a href="{{route('tailoredinvestment')}}">Tailored Investment Approach</a></h4>
          <p>We would help you meet your longer-term goals with a tailored investment strategy that’s specifically designed for you because we believe an informed investor is a better investor and a happier client.
           </p>
        </div>
      </div>
  ...
  <!-- ======= Team Section ======= -->
   <section id="team" class="team section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>How To</h2>
        <p>At Aspen financial management, we open our doors to professionals of all orientations, races, abilities, genders, and life experiences. In addition, we offer an accommodating and flexible work environment so that our associates can maximize their effectiveness at home, at work, and within their communities.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
          <div class="member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              ...
              <video controls="" id="vidmate" style="max-width: 100%; height: auto;">
                <source src="https://aspen-fm.com/assets/images/aspen-vid.mp4" type="video/mp4">
            </video>
        ...
        <!-- <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="member" data-aos="fade-up" data-aos-delay="400">
            <div class="member-img">
              <img src="assets/img/team/dave.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/WYsrsI5awSM" frameborder="0" allowfullscreen></iframe>
</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <h4>USA</h4>
              <p>
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/QwcaBbq9E0U" frameborder="0" allowfullscreen></iframe>
</p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <h3>Caleb Rotstein</h3>
              <h4>USA</h4>
              <p>
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/rVwXwyAJwtw" frameborder="0" allowfullscreen></iframe>
              </p>
            </div>
          </div>
        </div><!-- End testimonial item -->
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <h4>USA</h4>
              <p>
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/7sM78g5MVdc" frameborder="0" allowfullscreen></iframe>
              </p>
            </div>
          </div>
        </div><!-- End testimonial item -->
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              <!-- <img src="assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt=""> -->
              <h3>Rowell Griffiths</h3>
              <h4>Wales, UK</h4>
              <p>
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/gy_vn83Rsbg" frameborder="0" allowfullscreen></iframe>
              </p>
            </div>
          </div>
        </div><!-- End testimonial item -->
  ...
  <div class="container">
    <div class="row ">
      <div class="col-md-4">
        <div class="card card-body">
            ...
            <a href="https://aspen-fm.io/register" style="width: fit-content;">Invest in Stocks</a>
      ...
      <div class="col-md-4">
        <div class="card card-body">
            ...
            <a href="https://aspen-fm.io/register" style="width: fit-content;">Buy Cryptocurrencies</a>
            <div style="padding: 0;margin: 0;">
      ...
      <div class="col-md-4">
        <div class="card card-body">
            ...
            <a href="https://aspen-fm.io/register" style="width: fit-content;">Trade Now</a>
            <div style="padding: 0;margin: 0;">
    ...
    <div class="row" style="margin-top: 100px;">
      <div class="col-md-6">
        ...
        <a href="https://aspen-fm.io/register" style="width: fit-content;">Start Trading</a>
        <div style="border-left: 1px solid black;margin-top: 40px;padding: 15px;">
          <h1 id="demo" style="color: green;font-size: 70px;font-weight: 800;">8,740,247</h1>
          <h6>TRADES OPENED </h6>
          <script>
      ...
      <div class="col-md-6">
        ...
        <div class="tradingview-widget-container" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget1">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3ATSLA#%7B%22symbol%22%3A%22NASDAQ%3ATSLA%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
color: #2962FF !important;
        ...
        <!-- TradingView Widget BEGIN -->
        <div class="tradingview-widget-container" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget2">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AAAPL#%7B%22symbol%22%3A%22NASDAQ%3AAAPL%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
color: #2962FF !important;
        ...
        <!-- TradingView Widget END -->
        <!-- TradingView Widget BEGIN -->
        <div class="tradingview-widget-container active6" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget3">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AAMZN#%7B%22symbol%22%3A%22NASDAQ%3AAMZN%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
color: #2962FF !important;
        ...
        <!-- TradingView Widget END -->
        <!-- TradingView Widget BEGIN -->
        <div class="tradingview-widget-container active6" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget4">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AMSFT#%7B%22symbol%22%3A%22NASDAQ%3AMSFT%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
color: #2962FF !important;
        ...
        <!-- TradingView Widget END -->
        <!-- TradingView Widget BEGIN -->
        <div class="tradingview-widget-container" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget5">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3ANFLX#%7B%22symbol%22%3A%22NASDAQ%3ANFLX%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
color: #2962FF !important;
        ...
        <!-- TradingView Widget END -->
        <!-- TradingView Widget BEGIN -->
        <div class="tradingview-widget-container" style="margin-bottom: 3px; width: 100%; height: 230px;" id="widget6">
          <iframe scrolling="no" allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/symbol-info/?locale=en&amp;symbol=NASDAQ%3AFB#%7B%22symbol%22%3A%22NASDAQ%3AFB%22%2C%22width%22%3A%22100%25%22%2C%22colorTheme%22%3A%22light%22%2C%22isTransparent%22%3Afalse%2C%22height%22%3A205%2C%22utm_source%22%3A%22aspen-fm.io%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-info%22%2C%22page-uri%22%3A%22aspen-fm.io%2F%22%7D" title="symbol info TradingView widget" lang="en" style="user-select: none; box-sizing: border-box; display: block; height: 230px; width: 100%;"></iframe>
...
<section id="faq" class="faq">
  <div class="container" data-aos="fade-up">
    ...
    <ul class="faq-list accordion" data-aos="fade-up">
      ...
      <li>
        <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq1">Who are Aspen financial management? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq1" class="collapse" data-bs-parent=".faq-list">
          <p>
           Aspen financial management is registered with the SEC as an investment adviser providing asset management to high net worth individuals and institutions worldwide. We uphold the industry’s highest standard of care and help investors reach their long-term goals through active money management. When you hire Aspen financial management to help manage your money, you can expect a personalized, rewarding investment experience and world-class service.
          </p>
        </div>
      </li>

      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq2" class="collapsed">What makes us different from other money managers? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq3" class="collapsed">What services do we provide? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq3" class="collapse" data-bs-parent=".faq-list">
          <p>
           Through tailored portfolio management, we help high net worth individuals and institutions around the world reach their long-term financial goals. As a client, you will benefit from a comprehensive, personalized financial plan helping you confidently save, spend and invest. Communication and service are tailored to your needs. In addition, we can help with financial planning, budgeting, cash-flow analysis, estate tax planning and strategies for maximizing Social Security benefits. Beyond investing and financial planning, we want to help make you a more comfortable, disciplined and informed investor. That’s why you’ll have a dedicated Investment Counselor to help you understand what’s going on in your account and why.
          </p>
        </div>
      </li>

      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq4" class="collapsed">What is our approach to investing? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq5" class="collapsed">What is our fee structure? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq6" class="collapsed">What is our performance history? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq6" class="collapse" data-bs-parent=".faq-list">
          <p>
            We are proud of our performance history. In 2000, David William Davies founded Aspen financial management and began managing discretionary assets with a fundamental belief in capitalism and free capital markets. We start with the simple notion that supply and demand are the sole determinants of securities pricing. In addition, we believe capital markets are relatively efficient discounters of all widely known information. Thus, to add value through active management, one must identify information not widely known or interpret widely known information differently and correctly from other market participants. Throughout our history, we have continuously developed ways to look at capital markets differently. Our research has led us to develop practical applications of behavioral finance in our portfolio management process may sound surprising, but not all money managers take such a disciplined approach to measuring or advertising performance. That’s why we urge investors to remember past performance is not indicative of future results and should only be one of many considerations when choosing a money manager. You should also weigh the quality of service and advice and if the business is structured to put your needs first. In addition, we have dedicated significant resources to the emerging field of behavioral finance to better understand not just the tools of finance, but also how investors use these tools.
          </p>
        </div>
      </li>

      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq7" class="collapsed">What is the minimum required to be a client? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq7" class="collapse" data-bs-parent=".faq-list">
          <p>
            Aspen financial management ocuses on high net worth individuals with investable assets. When you start, we saw an opportunity to help an underserved market with different needs than other investors. We’re dedicated to serving clients who have worked hard throughout their lives with investing advice, tailored solutions and ongoing support.
          </p>
        </div>
      </li>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq8" class="collapsed">How do i become a client? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq8" class="collapse" data-bs-parent=".faq-list">
          <p>
          We will guide you through every step of becoming a new client. Our hands-on approach respects your time, keeps you informed and reduces the amount of paperwork you need to fill out.
          </p>
        </div>
      </li>
      ...
      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq9" class="collapsed">What type of investments do you hold for clients? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq9" class="collapse" data-bs-parent=".faq-list">
          <p>
          We primarily invest in domestic and foreign common stocks, fixed income securities, real estate, crypto currency and other derivatives that can include leverage. We also sometimes use hedging instruments such as short equity positions and options when it’s appropriate given your situation and current market conditions. Your long-term financial goals always determine our investment choices.
          </p>
        </div>
      </li>

      <li>
        <a data-bs-toggle="collapse" data-bs-target="#faq10" class="collapsed">How do we protect client accounts? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        <div id="faq10" class="collapse" data-bs-parent=".faq-list">
          <p>
          We take your security and privacy seriously and have implemented numerous layers of security measures for you. When you invest with Aspen financial management, we manage your investments, but your assets are held by a third-party custodian. Using a third-party custodian helps in reducing conflicts of interest and promotes transparency. In addition, employees are supported by comprehensive data management systems and security policies to protect client data from external and internal threats Lastly, rest assured we never share or sell your name for marketing purposes.
          </p>
        </div>
      </li>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="info-box mt-4">
              ...
              <h3>Email Us</h3>
              <p>info@aspen-fm.com<br>contact@aspen-fm.com</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info-box mt-4">
