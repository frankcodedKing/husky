                ...
                @if ($posts)
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ \Illuminate\Support\Str::limit(implode(' ', array_slice(str_word_count($post->content, 1), 0, 15)), $limit = 100, $end = '...') }}</p>
</p>
<a class="btn btn-success" href="{{route('showpost',$post->id)}}">Read more →</a>
                        </div>
                    </div>
