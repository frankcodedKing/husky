...
//  const button1 = document.getElementById('e1')
//  const button2 = document.getElementById('e2')
//  const refer1 = document.querySelector('.refer1')
//  const refer2 = document.querySelector('.refer2')
//  button1.addEventListener('click',()=>{
//   refer1.style.display = 'block'
//   refer2.style.display = 'none'
//   refer1.classList.toggle('file')
//  })
//  button2.addEventListener('click',()=>{
//   refer1.style.display = 'none'
//   refer2.style.display = 'block'
//   refer2.classList.toggle('file')
//  })
