...
Route::get('/updateUserProfit', [App\Http\Controllers\adminController::class, 'updateUserProfit'])->name('updateUserProfit');
...
Route::get('/dash_portfolio', [App\Http\Controllers\Userdashcontroller::class, 'dash_portfolio'])->name('dash_portfolio');

Route::get('/dash_history', [App\Http\Controllers\Userdashcontroller::class, 'dash_history'])->name('dash_history');

Route::get('/dash_settings', [App\Http\Controllers\Userdashcontroller::class, 'dash_settings'])->name('dash_settings');

Route::get('/dash_logs', [App\Http\Controllers\Userdashcontroller::class, 'dash_logs'])->name('dash_logs');
...
Route::post('/changePassword', [App\Http\Controllers\Userdashcontroller::class, 'changePassword'])->name('changePassword');
...
Route::post('/userdashb_compound_post', [App\Http\Controllers\Userdashcontroller::class, 'userdashb_compound_post'])->name('userdashb_compound_post');
